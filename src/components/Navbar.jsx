          ...
          <nav className="hidden md:flex space-x-6 text-sm font-medium text-white">
            ...
            <div className="relative about-dropdown">
              ...
              >
                ...
                <a
                  href="#"
                  className="block px-4 py-2 hover:bg-gray-100 rounded-b-lg transition"
                  onClick={() => setShowAboutMenu(false)}
                >
                  FAQ's
                </a>
              ...
              {showSearch && (
                <div className="absolute top-full right-0 mt-3">
                  <input
                    ...
                    className="w-64 border border-white/20 text-white px-4 py-2 rounded-full 
                               focus:outline-none focus:ring-2 focus:ring-white/50 bg-black/60 
                               backdrop-blur-lg placeholder-gray-300"
                  />
                </div>
              )}
            </div>
              ...
              {showProfileMenu && (
                <div className="absolute right-0 mt-4 flex flex-col items-center space-y-3 z-50 animate-fadeIn">
                  <button
                    ...
                    transition-all shadow-[0_4px_20px_rgba(255,255,255,0.1)]"
                  >
                    login
                  </button>
                  <button
